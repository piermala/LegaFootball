...
public class GestioneCampionato {
	...
	/// aggiungo tutte le squadre alla lista delle squadre presente nella classe Campionato
	...
	/// questo metodo ritorna la squadra con la differenza reti più bassa
	...
	/// questo metodo ritorna la classifica completa, in base ai punti, e, se nel caso questi fossero uguali, in base alla differenza reti prima ed ai goal segnati poi
